<?php include 'template/headermanajer.php';?>
...
if(isset($_POST['get'])){
  require "config.php";
    ...
    $telp = $_POST['telp'];
    $pass = $_POST['pass'];
    $result = mysqli_query($conn, "UPDATE manajer SET user='$user', pass='$pass',nama_toko='$toko',alamat='$alamat',telp='$telp'
     WHERE id_manajer = '$id' ") or die(mysqli_connect_error());
    if(!$result){
        echo "
        ...
        <meta http-equiv='refresh' content='1; url= pengaturanmanajer.php'/>
        ";
        } else{
        echo "
...
<?php
$result1 = mysqli_query($conn, "SELECT * FROM manajer");
        ...
        <div class="card-header bg-purple">
            ...
            <div class="card-body">
                ...
                <fieldset>
                  ...
                  <input type="hidden" name="id_manajer" value="<?php echo $id;?>">
