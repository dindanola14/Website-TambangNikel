    ...
    <div class="col-md-6 mb-3">
        <div class="card">
            ...
            <div class="form-group row mb-0">
                        ...
                        <div class="col-sm-8 mb-2">
                            <input type="text" class="form-control form-control-sm" name="kasir" id="kasir" required> 
                        </div>
                        <label class="col-sm-4 col-form-label col-form-label-sm"><b>Nomer Meja</b></label>
                        <div class="col-sm-8 mb-2">
                            <input type="number" class="form-control form-control-sm" name="no_meja" id="no_meja" required> 
                        </div>
            ...
            if(isset($_POST['save'])){
                ...
                $sql = "INSERT INTO keranjang (kode_barang, kasir, no_meja, nama_barang, harga_barang, quantity, subtotal, tgl_input)
                 VALUES('$idb','$kasir','$no_meja','$nama','$harga','$qty','$total','$tgl')";
...
function format_ribuan ($nilai){
    return number_format ($nilai, 0, ',', '.');
                ...
                $tot_bayar += $total;
                $bayar = ($r['bayar'] == null) ? 0 : $r['bayar']; //short hand if 
                $kembalian = ($r['kembalian'] == null) ? 0 : $r['kembalian'];
             }
             error_reporting(1);
                ?>
            <form method="POST">
...
<!-- tes -->
  <div class="col-md-6 mb-3">
      ...
      $no_mejah = mysqli_query($conn,"SELECT * FROM keranjang");
      while($nm = mysqli_fetch_array($no_mejah)){
        $no_meja = $nm['no_meja'];
        $kasir = $nm['kasir'];
        $tgl = $nm['tgl_input'];
      }
      ...
      <?php
               if(isset($_POST['selesai'])){
                $ambildata = mysqli_query($conn,"INSERT INTO laporanku (kasir, no_transaksi,bayar,kembalian,id_Cart,kode_barang, nama_barang, harga_barang, quantity, subtotal, tgl_input)
                SELECT kasir, no_transaksi,bayar,kembalian,id_Cart,kode_barang, nama_barang, harga_barang, quantity, subtotal, tgl_input
