...
if(isset($_POST['get'])){
  require "config.php";
    ...
    $telp = $_POST['telp'];
    $pass = $_POST['pass'];
    $result = mysqli_query($conn, "UPDATE kasir SET user='$user', pass='$pass',nama_toko='$toko',alamat='$alamat',telp='$telp' WHERE id_kasir = '$id' ") or die(mysqli_connect_error());
    if(!$result){
        echo "
        ...
        <meta http-equiv='refresh' content='1; url= pengaturankasir.php'/>
        ";
        } else{
        echo "
...
<?php
$result1 = mysqli_query($conn, "SELECT * FROM kasir");
        ...
        <div class="card-header bg-purple">
            ...
            <div class="card-body">
                ...
                <fieldset>
                  ...
                  <input type="hidden" name="id_kasir" value="<?php echo $id;?>">
