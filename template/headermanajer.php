...
<nav class="navbar navbar-expand-lg navbar-dark bg-purple text-white shadow-sm sticky-top d-md-none d-lg-none d-xl-none">
  ...
  <?php 
      $toko = mysqli_query($conn,"SELECT * FROM manajer ORDER BY nama_toko ASC");
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav">
          ...
          <li class="nav-item">
              <a class="nav-link putih" href="barangmanajer.php"><i class="fa fa-shopping-bag mr-2"></i>Barang</a>
          </li>
          <li class="nav-item">
              <a class="nav-link putih" href="laporanmanajer.php"><i class="fa fa-table mr-2"></i>Laporan</a>
          </li>
          <li class="nav-item">
              <a class="nav-link putih" href="pengaturanmanajer.php"><i class="fa fa-cog mr-2"></i>Pengaturan</a>
          </li>
          <li class="nav-item">
              <a class="nav-link putih" href="logoutmanajer.php" onclick="javascript:return confirm('Anda yakin ingin keluar ?');"><i class="fa fa-power-off mr-2"></i>Keluar</a>
          </li>
      </ul>
  </div>
</nav>
        ...
        <div class="card">
            ...
            <div class="card-body">
              <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                      <a class="nav-link" href="barangmanajer.php"><i class="fa fa-shopping-bag text-purple mr-2"></i>Barang</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="laporanmanajer.php"><i class="fa fa-table text-purple mr-2"></i>Laporan</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="pengaturanmanajer.php"><i class="fa fa-cog text-purple mr-2"></i>Pengaturan</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="logoutmanajer.php"onclick="javascript:return confirm('Anda yakin ingin keluar ?');"><i class="fa fa-power-off text-purple mr-2"></i>Keluar</a>
                  </li>
              </ul>
         </div>
    </div>
